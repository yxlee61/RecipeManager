namespace RecipeManager.Migrations
{
  ...
  internal sealed class Configuration : DbMigrationsConfiguration<RecipeManager.Models.RecipeDbContext>
  {
    public Configuration()
    {
      AutomaticMigrationsEnabled = false;
      ContextKey = "RecipeManager.Models.RecipeDbContext";
    }

    protected override void Seed(RecipeManager.Models.RecipeDbContext context)
    {
